  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="pelanggan">
        ...
        <div class="sidebar-brand-text mx-2">INTEK service</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsetable" class="collapse" aria-labelledby="headingtable" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="{{ url('service') }}">table service</a>
            <a class="collapse-item" href="{{ url('pelanggan')}}">tabel pelanggan</a>
          </div>
        </div>
      </li>
